      ...
      <div ref={navlinksRef} className=" relative">
        <div className="navlink flex justify-between items-start p-2 w-full">
          ...
          <div ref={closebtn} onClick={() => {
            setNavOpen?.(false)
          }} className="closeAnimation h-35 w-35  relative cursor-pointer">
            <div className="h-48 w-0.5 bg-white -rotate-45 origin-top absolute "></div>
            <div className="h-48 w-0.5 bg-white right-0 rotate-45 origin-top absolute "></div>
          </div>
        </div>
        <div className="font-[font-2] relative cursor-pointer overflow-hidden">
          <div className=" link border-y origin-top  relative  ">
            <h1 className="text-[8vw] uppercase leading-[1vw] py-18 text-center">Work</h1>
            <div className=" moveX-hover flex absolute top-0 bottom-0 bg-[#D3FD50] ">
              <div className="moveAnim flex items-center leading-[1vw]  ">
          ...
          <div className=" link border-t border-t-white  origin-top relative ">
            <h1 className="text-[8vw] uppercase leading-[1vw] py-18 text-center">Agency</h1>
            <div className="moveX-hover flex absolute top-0 bottom-0 bg-[#D3FD50] ">
              <div className="moveAnim flex items-center  leading-[1vw]  ">
          ...
          <div className=" link border-t border-t-white origin-top relative ">
            <h1 className="text-[8vw] uppercase leading-[1vw] py-18 text-center">contact</h1>
            <div className=" moveX-hover flex absolute top-0 bottom-0  bg-[#D3FD50] ">
              <div className="moveAnim flex items-center  leading-[1vw]  ">
          ...
          <div className=" link border-y border-white origin-top relative ">
            <h1 className="text-[8vw] uppercase leading-[1vw] py-18 text-center">blog</h1>
            <div className=" moveX-hover flex absolute top-0 bottom-0 bg-[#D3FD50] ">
              <div className="moveAnim flex items-center  leading-[1vw]  ">
